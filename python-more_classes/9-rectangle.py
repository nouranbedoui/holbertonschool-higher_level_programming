#!/usr/bin/python3
"""
Defines a Rectangle class with validation, area, perimeter,
string representation, deletion message, comparison, and square creation.
"""


class Rectangle:
    """Represents a rectangle with validation and comparison."""
    ...
    def __repr__(self):
        """Return a string for creating a new instance."""
